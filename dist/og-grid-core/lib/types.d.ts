...
export declare type TextFilterMode = 'contains' | 'startsWith' | 'equals';
export declare type AggregationType = 'sum' | 'min' | 'max' | 'avg' | 'count';
export interface AggModelItem {
    colId: string;
    aggFunc: AggregationType | ((values: any[]) => any);
}
export declare type FilterType = 'text' | 'number' | 'date';
...
export declare type RowView<T = any> = T | GroupViewRow<T>;
